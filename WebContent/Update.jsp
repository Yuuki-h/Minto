...
<html>
	...
	<!-- jqGrid 表示ここから -->
		...
		<%
			...
			String db_id_ins = request.getParameter("name_select");
			...
			String db_disp_ins = request.getParameter("name_disp_add");
 			if(db_id_ins != null)
			{
				String mySql = "update t_user_list set user_name='"+db_name_ins+"',user_pass='"+db_pass_ins+"',disp_name='"+db_disp_ins+"'   where user_id=('"+db_id_ins+"');";
//update テーブル名 set user_name='a1',user_pass='a2' where user_id=2;
				db.execute(mySql);
			}
			// メンバーを取得
